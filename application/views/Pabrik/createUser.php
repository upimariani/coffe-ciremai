                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('Pabrik/cUser/create') ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="<?= set_value('no_rek') ?>" name="no_rek" class="form-control" placeholder="Enter No Rekening">
                                <?= form_error('no_rek', '<small id="emailHelp" class="form-text text-danger">', '</small>') ?>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Username*</label>
                                <input type="text" value="<?= set_value('username') ?>" name="username" class="form-control" placeholder="Enter Username">
                                <?= form_error('username', '<small id="emailHelp" class="form-text text-danger">', '</small>') ?>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Password*</label>
                                <input type="text" value="<?= set_value('password') ?>" name="password" class="form-control" placeholder="Enter Password">
