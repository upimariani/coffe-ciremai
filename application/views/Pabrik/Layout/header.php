		...
		<div class="sidebar-menu">
			...
			<div class="main-menu">
				<div class="menu-inner">
					<nav>
						<?php
						$bb = $this->mDashboard->notif_produk_kurang();
						$no = 1;
						...
						$notif_pesanan = $this->mDashboard->notif_pemesanan();
						?>

						<ul class="metismenu" id="menu">
							<li <?php if ($this->uri->segment(1) == 'Pabrik' && $this->uri->segment(2) == 'cDashboard') {
									echo 'class="active"';
								}  ?>><a href="<?= base_url('Pabrik/cDashboard') ?>"><i class="ti-dashboard"></i> <span>Dashboard</span><span class="badge badge-danger"><?= $angka ?></span></a></li>
							...
							<li <?php if ($this->uri->segment(1) == 'Pabrik' && $this->uri->segment(2) == 'cPemesanan') {
									echo 'class="active"';
								}  ?>><a href="<?= base_url('Pabrik/cPemesanan') ?>"><i class="ti-bag"></i> <span>Pemesanan</span><span class="badge badge-danger"><?= $notif_pesanan->jml ?></span></a></li>
