...
<script src="<?= base_url('asset/srtdash/srtdash/') ?>assets/js/line-chart.js"></script>
<!-- all pie chart -->
<script src="<?= base_url('asset/srtdash/srtdash/') ?>assets/js/pie-chart.js"></script>
<!-- all bar chart -->
<script src="<?= base_url('asset/srtdash/srtdash/') ?>assets/js/bar-chart.js"></script>
<!-- all map chart -->
<script src="<?= base_url('asset/srtdash/srtdash/') ?>assets/js/maps.js"></script>
<!-- others plugins -->
