    ...
    <div class="row align-items-center">
        <div class="col-sm-6 mb-5 mt-5">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Create New Bahan Baku</h4>
    ...
    <div class="row">
        <div class="col-lg-6 col-ml-12">
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Create New Bahan Baku</h4>
                        <form action="<?= base_url('Supplier/cBahanBaku/create') ?>" method="POST">
