    ...
    <div class="sales-report-area mt-5 mb-5">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Informasi Stok Bahan Jadi Distributor</h4>
                        <div class="cripto-live mt-5">
                            <ul>
                                <?php
                                ...
                                ?>
                                    <li>
                                        <?= $value->nm_bhn_jd ?><span><i class="<?php if ($value->stok_distributor <= 3) {
                                                                                    echo 'fa fa-long-arrow-down';
                                                                                } else {
                                                                                    echo 'fa fa-long-arrow-up';
                                                                                } ?>"></i>Stok: <span <?php if ($value->stok_distributor <= 3) {
                                                                                                            echo 'class="badge badge-danger"';
                                                                                                        } else {
                                                                                                            echo 'class="badge badge-success"';
                                                                                                        } ?>> <?= $value->stok_distributor ?></span></span>
                                    </li>
                                <?php
                                }
                                ?>
